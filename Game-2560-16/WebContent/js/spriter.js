...
(function (Spriter) {
    ...
    // -------------------------------------------------------------------------
    // B(t) = (1 âˆ’ t)^3 * P0 + 3(1 âˆ’ t)^2 * t * P1 + 3(1 âˆ’ t) *  t^2 * P2 + t^3 * P3  , 0 â‰¤ t â‰¤ 1.
...
Spriter.loader = null;
Spriter.cache = {};
Spriter.Actor = function(game, x, y, spriterProjectKey, texutreKey, entityName) {
	var spriter=null;
	if(Spriter.loader == null){
	   Spriter.loader = new Spriter.Loader()
    }
    if(!Spriter.cache[spriterProjectKey]){
	    var file = game.cache.getJSON(spriterProjectKey);
	    var json = new Spriter.SpriterJSON(file);
	    spriter  = Spriter.loader.load(json);
	    Spriter.cache[spriterProjectKey] = spriter;
    }else{
    	spriter = Spriter.cache[spriterProjectKey];
    }
	Spriter.SpriterGroup.call(this, game, spriter, texutreKey, entityName, 0,100);
	this.game = game;
    this.type = Phaser.ACTOR;
    this.physicsType = Phaser.SPRITE;
    this.anchor = new Phaser.Point(0.5,1);    
    Phaser.Component.Core.init.call(this,game, x, y, '', null);    
};


var proto = Object.create(Spriter.SpriterGroup.prototype);
Spriter.Actor.prototype = proto;
Spriter.Actor.prototype.constructor = Spriter.Actor;

Spriter.Actor.prototype.initBody = function(){
   this.body.bounce.y = 0.3;
   this.body.collideWorldBounds = true;
   this.body.drag.x = 500;
}

Spriter.Actor.prototype.update = function() {
	this.updateAnimation();
};

Spriter.Actor.prototype.play = function(animationName,animationSpeedPercent) {
	if (animationSpeedPercent!=undefined){
		this.setAnimationSpeedPercent(animationSpeedPercent);
	}
...
Phaser.Component.Core.install.call(Spriter.Actor.prototype, [ 
        'Angle',
		'Bounds', 
		'BringToTop',	
		'Crop',
...
Spriter.Actor.prototype.preUpdatePhysics  = Phaser.Component.PhysicsBody.preUpdate;
Spriter.Actor.prototype.preUpdateLifeSpan = Phaser.Component.LifeSpan.preUpdate;
Spriter.Actor.prototype.preUpdateInWorld  = Phaser.Component.InWorld.preUpdate;
Spriter.Actor.prototype.preUpdateCore     = Phaser.Component.Core.preUpdate;
Spriter.Actor.prototype.postUpdatePhysics = Phaser.Component.PhysicsBody.postUpdate;
 ...
 */
Spriter.Actor.prototype.preUpdate = function() {
	if(this.body){
...
Spriter.Actor.prototype.postUpdate = function() {	
	return this.postUpdatePhysics();
};


Phaser.GameObjectFactory.prototype.spriter = function(x,y,spriterProjectKey,texutreKey,entityName,group){
  if (group === undefined) { group = this.world; }
  var obj = new Spriter.Actor(this.game, x, y, spriterProjectKey,texutreKey,entityName);
